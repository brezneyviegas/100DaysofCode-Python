...
if left_right.lower() == "right":
  ...
  swim_wait = input("Well done we move on\nWould you like to Swim or Wait?")
  if swim_wait.lower() == "swim":
    print("Game Over!\nBetter luck next time!!!")
  elif swim_wait.lower() == "wait":
    which_door = input("Well done for waiting!\nNow pick a door, Red, Yellow or Blue?")
    if which_door.lower() == "red" or which_door.lower() == "red":
      print("Game Over!\nBetter luck next time!!!")
